...
import Calender from '../components/home_comp/Calender'
import FeesCard from '../components/home_comp/FeesCard'
        ...
        <>
            <div className='h-screen w-full mt-3 pe-6 text-gray-700'>
                <div className='h-max w-full border border-borderSecondary rounded bg-white px-5 pt-2 flex flex-col gap-3 pb-6'>
                    ...
                    <div>
                        ...
                        <div className='h-max w-full px-2 py-4'>
                            ...
                            <form className='h-full w-full mt-3' >
                                ...
                                <div className='flex gap-6 items-center justify-center w-full mt-3'>
                                    ...
                                    <div className='flex flex-col gap-1 justify-center w-[50%]'>
                                        <label className='text-[14px] ml-1 text-textTitle' >Date of Birth</label>
                                        <input readOnly defaultValue='01/08/2005' className='border border-borderSecondary  px-2 py-2 rounded text-[14px] text-textTitle outline-none' />
                                    </div>
                                </div>
                                {/* this is the two input section */}
                                ...
                                <div className='flex gap-6 items-center justify-center w-full mt-3'>
                                    ...
                                    <div className='flex flex-col gap-1 justify-center w-[50%]'>
                                        <label className='text-[14px] ml-1 text-textTitle' >Aapar Id</label>
                                        <input readOnly defaultValue='12125454D' className='border border-borderSecondary  px-2 py-2 rounded text-[14px] text-textTitle outline-none' />
                                    </div>
                                </div>
                                {/* this is the two input section */}
                                ...
                                <div className='flex flex-col gap-1 justify-center mt-3'>
                                    <label className='text-[14px] ml-1 text-textTitle' >Category</label>
                                    <input readOnly defaultValue='OBC' className='border border-borderSecondary  px-2 py-2 rounded text-[14px] outline-none text-textTitle' />
                                </div>
                                {/* this is the full width input */}
                        ...
                        <div className='h-max w-full px-2 py-4'>
                            ...
                            <form className='h-full w-full mt-3' >
                                ...
                                <div className='flex gap-6 items-center justify-center w-full mt-3'>
                                    <div className='flex flex-col gap-1 justify-center w-[50%]'>
                                        <label className='text-[14px] ml-1 text-textTitle' >Parent's Phone Number</label>
                                        <input readOnly defaultValue='1212121212' className='border border-borderSecondary  px-2 py-2 rounded text-[14px] outline-none text-textTitle' />
                                    </div>
                                    <div className='flex flex-col gap-1 justify-center w-[50%]'>
                                        <label className='text-[14px] ml-1 text-textTitle' > Email Address</label>
                        ...
                        <div className='h-max w-full px-2 py-4'>
                            ...
                            <form className='h-full w-full mt-3' >
                                ...
                                <div className='flex gap-6 items-center justify-center w-full mt-3'>
                                    <div className='flex flex-col gap-1 justify-center w-[50%]'>
                                        <label className='text-[14px] ml-1 text-textTitle' >Class</label>
                                    ...
                                    <div className='flex flex-col gap-1 justify-center w-[50%]'>
                                        <label className='text-[14px] ml-1 text-textTitle' >Roll Number</label>
                                        <input readOnly defaultValue='23202731' className='border border-borderSecondary  px-2 py-2 rounded text-[14px] text-textTitle outline-none' />
                                    </div>
                                </div>
                                {/* this is the two input section */}
                                ...
                                <div className='flex gap-6 items-center justify-center w-full mt-3'>
                                    <div className='flex flex-col gap-1 justify-center w-[50%]'>
                                        <label className='text-[14px] ml-1 text-textTitle' >Stream</label>
                                    ...
                                    <div className='flex flex-col gap-1 justify-center w-[50%]'>
                                        <label className='text-[14px] ml-1 text-textTitle' >Admission Date</label>
                    ...
                    {/* this is the attendance portion */}
                    <div className='px-2 py-4'>
                        <h1 className='text-xl font-semibold'>Attendance Details</h1>
                        <Calender />
                    </div>
                    {/* this is the attendance portion */}

                    {/* this is the fee portion */}
                    <div className='px-2 py-4'>
                        <h1 className='text-xl font-semibold'>Fees Details</h1>
                        <FeesCard/>
                    </div>
                    {/* this is the fee portion */}
